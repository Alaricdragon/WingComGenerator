...
public class Bean_Ship {
    ...
    public Bean_Ship(Bean_Ship b){
          ...
          name=b.name.isBlank() ? "" : b.name;

          id=b.id.isBlank() ? "" : b.id;

          designation=b.designation.isBlank() ? "" : b.designation;
          tech_manufacturer=b.tech_manufacturer.isBlank() ? "" : b.tech_manufacturer;
          system_id=b.system_id.isBlank() ? "" : b.system_id;
          fleet_pts=b.fleet_pts.isBlank() ? "" : b.fleet_pts;

          hitpoints=b.hitpoints.isBlank() ? "" : b.hitpoints;
          armor_rating=b.armor_rating.isBlank() ? "" : b.armor_rating;
          max_flux=b.max_flux.isBlank() ? "" : b.max_flux;
          _8654=b._8654.isBlank() ? "" : b._8654;
          flux_dissipation=b.flux_dissipation.isBlank() ? "" : b.flux_dissipation;
          ordnance_points=b.ordnance_points.isBlank() ? "" : b.ordnance_points;
          fighter_bays=b.fighter_bays.isBlank() ? "" : b.fighter_bays;
          max_speed=b.max_speed.isBlank() ? "" : b.max_speed;

          acceleration=b.acceleration.isBlank() ? "" : b.acceleration;

          deceleration=b.deceleration.isBlank() ? "" : b.deceleration;
          max_turn_rate=b.max_turn_rate.isBlank() ? "" : b.max_turn_rate;
          turn_acceleration=b.turn_acceleration.isBlank() ? "" : b.turn_acceleration;

          mass=b.mass.isBlank() ? "" : b.mass;
          shield_type=b.shield_type.isBlank() ? "" : b.shield_type;
          defense_id=b.defense_id.isBlank() ? "" : b.defense_id;
          shield_arc=b.shield_arc.isBlank() ? "" : b.shield_arc;
          shield_upkeep=b.shield_upkeep.isBlank() ? "" : b.shield_upkeep;
          shield_efficiency=b.shield_efficiency.isBlank() ? "" : b.shield_efficiency;
          phase_cost=b.phase_cost.isBlank() ? "" : b.phase_cost;
          phase_upkeep=b.phase_upkeep.isBlank() ? "" : b.phase_upkeep;
          min_crew=b.min_crew.isBlank() ? "" : b.min_crew;
          max_crew=b.max_crew.isBlank() ? "" : b.max_crew;

          cargo=b.cargo.isBlank() ? "" : b.cargo;

          fuel=b.fuel.isBlank() ? "" : b.fuel;
          fuel_ly=b.fuel_ly.isBlank() ? "" : b.fuel_ly;

          range=b.range.isBlank() ? "" : b.range;
          max_burn=b.max_burn.isBlank() ? "" : b.max_burn;
          base_value=b.base_value.isBlank() ? "" : b.base_value;
          cr_day=b.cr_day.isBlank() ? "" : b.cr_day;
          CR_to_deploy=b.CR_to_deploy.isBlank() ? "" : b.CR_to_deploy;
          peak_CR_sec=b.peak_CR_sec.isBlank() ? "" : b.peak_CR_sec;
          CR_loss_sec=b.CR_loss_sec.isBlank() ? "" : b.CR_loss_sec;
          supplies_rec=b.supplies_rec.isBlank() ? "" : b.supplies_rec;
          supplies_mo=b.supplies_mo.isBlank() ? "" : b.supplies_mo;
          c_s=b.c_s.isBlank() ? "" : b.c_s;
          c_f=b.c_f.isBlank() ? "" : b.c_f;
          f_s=b.f_s.isBlank() ? "" : b.f_s;
          f_f=b.f_f.isBlank() ? "" : b.f_f;
          crew_s=b.crew_s.isBlank() ? "" : b.crew_s;
          crew_f=b.crew_f.isBlank() ? "" : b.crew_f;

          hints=b.hints.isBlank() ? "" : b.hints;

          tags=b.tags.isBlank() ? "" : b.tags;
          logistics_n_a_reason=b.logistics_n_a_reason.isBlank() ? "" : b.logistics_n_a_reason;
          codex_variant_id=b.codex_variant_id.isBlank() ? "" : b.codex_variant_id;

          rarity=b.rarity.isBlank() ? "" : b.rarity;

          breakProb=b.breakProb.isBlank() ? "" : b.breakProb;

          minPieces=b.minPieces.isBlank() ? "" : b.minPieces;

          maxPieces=b.maxPieces.isBlank() ? "" : b.maxPieces;
          travel_drive=b.travel_drive.isBlank() ? "" : b.travel_drive;

          number=b.number.isBlank() ? "" : b.number;
    }
